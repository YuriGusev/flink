...
public class DynamoDBSink<IN> extends RichSinkFunction<IN> implements CheckpointedFunction {
    ...
    public void open(Configuration parameters) {
        ...
        this.dynamoDBWriter = new DynamoDBBatchWriter(producer);
    ...
    public void invoke(IN value, Context context) throws Exception {
        ...
        dynamoDBSinkFunction.process(value, getRuntimeContext(), dynamoDBWriter);
    }
    ...
    private void checkAndPropagateAsyncError() throws Exception {
        if (thrownException != null) {
            ...
            if (thrownException instanceof BatchWriteFailedException) {
                List<Attempt> attempts =
                        ((BatchWriteFailedException) thrownException).getResult().getAttempts();
