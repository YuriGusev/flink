...
public class DynamoDbSink2<IN> extends AsyncSinkBase<IN, DynamoDbWriteRequest> {
    ...
    /**
     * Create a {@link DynamoDbSinkBuilder} to construct a new {@link DynamoDbSink2}.
     *
     * @param <IN> type of incoming records
